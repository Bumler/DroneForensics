...
public class camera_Activity extends Activity implements SurfaceTextureListener,OnClickListener{

    private static final String TAG = camera_Activity.class.getName();
            ...
            camera.setDJICameraUpdatedSystemStateCallback(new DJICamera.CameraUpdatedSystemStateCallback() {
                ...
                public void onResult(DJICamera.CameraSystemState cameraSystemState) {
                    if (null != cameraSystemState) {
                        ...
                        camera_Activity.this.runOnUiThread(new Runnable() {
    ...
    public void showToast(final String msg) {
        runOnUiThread(new Runnable() {
            public void run() {
                Toast.makeText(camera_Activity.this, msg, Toast.LENGTH_SHORT).show();
            }
        });
    }
